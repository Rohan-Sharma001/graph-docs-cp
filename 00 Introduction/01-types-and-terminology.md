...
- **Degree (of a vertex)**: Defined as the number of edges incident on a given vertex in an undirected graph.
...
- **Subgraph**: From the original graph take some of the vertices. If an edge connects vertices that aren't included, remove it. Then remove some, none, or all of the remaining edges.
